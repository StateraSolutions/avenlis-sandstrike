...
const Scan: React.FC = () => {
  ...
  const loadLLMConfigStatus = async () => {
    try {
      ...
      setOpenaiKeySet(response.data.openai_key_set)
                  ...
                  <>
                    <Grid item xs={12} md={6}>
                      <TextField
                        ...
                        placeholder="http://localhost:11434 or https://api.openai.com/v1/chat/completions"
                  ...
                  <FormControl fullWidth>
                    ...
                    >
                      ...
                      <MenuItem 
                        ...
                        sx={{ 
                          color: !openaiKeySet ? '#9e9e9e' : 'inherit',
                          opacity: !openaiKeySet ? 0.6 : 1
                        }}
                      >
                        OpenAI Grader (API Key Required)
                        {!openaiKeySet && (
                          <Chip 
                            label="No API Key" 
                            size="small" 
                      ...
                      >
                        Gemini Grader (API Key Required)
                        {!geminiKeySet && (
                          <Chip 
                            label="No API Key" 
                            size="small" 
                      ...
                      <MenuItem 
                        ...
                        disabled={!isProUser}
                        sx={{ 
                          color: !isProUser ? '#9e9e9e' : 'inherit',
