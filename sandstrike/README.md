...
- **Target Integration**: Support for Ollama, OpenAI, and custom HTTP endpoints
...
- **Encoding persistence**: Coming soon (currently not available)
...
### Import the Library
```python
from avenlis import AvenlisAPI, AvenlisAuth, AvenlisConfig
from avenlis.redteam import AvenlisRedteam
from avenlis.server import AvenlisServer
from avenlis.storage import AvenlisStorage
```
...
results = redteam.evaluate_attacks(
    ...
    attack_prompts=["prompt-injection", "prompt-probing"]  # Jailbreak scenarios coming soon
)
...
- **Smart Prompt Overlays**: Detailed information (encoding history coming soon)
- **Real-time Updates**: See results as they happen
...
- **Persistent Storage**: Save test results (encoding persistence coming soon)

### **Comprehensive Red Team Testing**
- **20+ Security Prompts**: Comprehensive security testing
- **Encoding methods**: Coming soon
...
3. **Red Team Engine**: Executes attacks (encoding support coming soon)
4. **Results**: Stored and displayed in real-time

### **Extension Points**
- **Custom Security Prompts**: Add new security test patterns
- **Custom Encoding Methods**: Coming soon
